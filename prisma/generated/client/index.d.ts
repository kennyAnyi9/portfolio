...
export namespace Prisma {
  ...
  */
  ...
  interface WordFieldRefs {
    ...
    readonly value: FieldRef<"Word", 'Int'>
    readonly username: FieldRef<"Word", 'String'>
  ...
  export type WordWhereInput = {
    ...
    value?: IntFilter<"Word"> | number
    username?: StringFilter<"Word"> | string
  ...
  export type WordWhereUniqueInput = Prisma.AtLeast<{
    id?: number
    text_username?: WordTextUsernameCompoundUniqueInput
    AND?: WordWhereInput | WordWhereInput[]
    OR?: WordWhereInput[]
    NOT?: WordWhereInput | WordWhereInput[]
    text?: StringFilter<"Word"> | string
  ...
  export type WordScalarWhereWithAggregatesInput = {
    ...
    value?: IntWithAggregatesFilter<"Word"> | number
    username?: StringWithAggregatesFilter<"Word"> | string
  ...
  export type WordTextUsernameCompoundUniqueInput = {
    text: string
    username: string
  }
