...
That is all it takes to implement a simple linked list in Javascript. In the part II, we will look at how to perform operations on the linked list like adding, deleting, and searching for items in the list.
